...
/**
 * The {@link Volumio2BindingConstants} class defines common constants, which are
...
public class Volumio2BindingConstants {
    ...
    private static final String BINDING_ID = "volumio2";

    // List of all Thing Type UIDs
    public static final ThingTypeUID THING_TYPE_VOLUMIO2 = new ThingTypeUID(BINDING_ID, "player");
